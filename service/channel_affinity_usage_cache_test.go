...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := nextChannelAffinityUsageCacheTestID("rule_claude")
	usingGroup := "default"
	keyFP := nextChannelAffinityUsageCacheTestID("fp_claude")
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_MixedMode(t *testing.T) {
	ruleName := nextChannelAffinityUsageCacheTestID("rule_mixed")
	usingGroup := "default"
	keyFP := nextChannelAffinityUsageCacheTestID("fp_mixed")
	ctx := buildChannelAffinityStatsContextForTest(ruleName, usingGroup, keyFP)
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_UnsupportedModeKeepsEmpty(t *testing.T) {
	ruleName := nextChannelAffinityUsageCacheTestID("rule_unsupported")
	usingGroup := "default"
	keyFP := nextChannelAffinityUsageCacheTestID("fp_unsupported")
	ctx := buildChannelAffinityStatsContextForTest(ruleName, usingGroup, keyFP)
