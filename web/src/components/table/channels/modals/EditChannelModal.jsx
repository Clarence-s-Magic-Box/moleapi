  ...
  const loadChannel = async () => {
    ...
    if (success) {
      ...
      const hasAdvancedValues =
        ...
        data.system_prompt_override;
      const savedAdvancedState = localStorage.getItem(
        ADVANCED_SETTINGS_EXPANDED_KEY,
      );
      if (savedAdvancedState === 'true') {
        toggleAdvancedSettings(true);
      } else if (savedAdvancedState !== 'false' && hasAdvancedValues) {
        toggleAdvancedSettings(true);
      }
    } else {
      showError(message);
              ...
              >
                <div className='semi-sidesheet-header'>
                  ...
                  <Button
                    ...
                    icon={<IconClose />}
                    size='small'
                    onClick={() => toggleAdvancedSettings(false)}
                  />
                </div>
